...
object MovieSearchFeatureModule {
    @Provides
    @Singleton
    fun providerMovieSearchDataSource(service: MovieService): MovieSearchRemoteDataSource {
    ...
    @Provides
    @Singleton
    fun provideGetMovieSearchUseCae(repository: MovieSearchRepository): GetMovieSearchUseCase {
